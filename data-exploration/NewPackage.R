...
# you need to add this to each file which requires the use of the package
help(package="vcd")      
library(vcd)
# to view the libraries that you have installed on your hard drive
library()
help(Arthritis)
Arthritis
example(Arthritis)
...
installed.packages()               # returns list of installed packages
library()                          # less verbose list
old.packages()                     # lists newer versions of installed packages
update.packages()

# where is the library 'C:/Program Files (x86)/R/R-2.13.1/library':
library() # what packages in the library: 'C:/Program Files (x86)/R/R-2.13.1/library':
...
install.packages( c("ggplot2","MASS","cluster","rpart"))
